...
public class pdf extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bill Viewer");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 229, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Enter Bill No:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 115, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, 120, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/abstract-colourful-lights-through-frozen-texture.jpg"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 220));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try 
        {
            ...
            if (!dir.exists()) 
            {
                    JOptionPane.showMessageDialog(this, "Folder D:\\pdf\\ does not exist.");
                    return;
            }
